...
\item
  ...
  Bilkent University. 
\item
  {\bf Enes Koşar:} M.Sc. student, Computer Engineering, Fall 2019 - present. 
  Bilkent University. 
\item
  {\bf Sepide Kazemi Firouzjaei:} M.Sc. student, Computer Engineering, Fall 2019 - present.
  Bilkent University. 
\end{list2}
...
\item
  PC Member, 24$^{th}$ Annual International Conference on Research in Computational Molecular Biology
  (RECOMB 2020),  May 10-13, 2019, Padova, Italy.
...
\item
  PC Member, 23$^{rd}$ Annual International Conference on Research in Computational Molecular Biology
  (RECOMB 2019),  May 5-7, 2019, Washington, DC, USA.
\item
...
\begin{list2}
\item Pengout: Mobile application to find events and organize group outings, 2019-\textit{current}.
...
{\small
Total of 63 invited talks, seminars, lectures, and keynotes.
}\\
