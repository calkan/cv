...
\begin{list2}
\item 
{\bf Malavi Sengupta}: Postdoc, co-advised with Ayça Ergül (Hacettepe University) and Mehmet Somel (Middle East Technical University), 2021 - present.
\item 
...
%\item {\bf Ege Demirkırkan:} B.Sc. student in Computer Engineering,  Bilkent University. Since Summer 2022.
...
\item
  ...
  \item
  \textbf{Organization Committee and General Co-Chair}, 27$^{th}$ Annual International Conference on Research in Computational Molecular Biology (RECOMB), 2023.
\item
