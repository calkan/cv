...
%    & {\it Web: http://www.alkanlab.org} & \\
  ...
  segmental duplications, hardware acceleration of bioinformatics algorithms. %; genotype-disease associations.
  %,
...
\end{list4}
  ...
  \begin{list2}
    ...
    Team Leaders: Onur Mutlu (ETH Zürich), Rayan Chikhi (Institut Pasteur), Dominique Lavenier (CNRS), Abu Sebastian (IBM Zürich), Ran Ginosar (Technion), Remy Cimadomo (UPMEM), Leonid Yavits (Bar-Ilan).
...
\item
  ...
  Bilkent University. 
  \item
  {\bf Ecem İlgün:} Computer Engineering, Spring 2023 - present.
\end{list2}

\vspace*{-.4cm}
  \subsection{\small \sc Undergraduate Volunteers}
  \begin{list2}
\item {\bf Akmuhammet Ashyralyyev:} B.Sc. student in Computer Engineering,  Bilkent University. Since Spring 2022.
\item {\bf S Celal Türkmen:} B.Sc. student in Computer Engineering,  Bilkent University. Since Summer 2022.
\item {\bf Berk Saltuk Yılmaz:} B.Sc. student in Computer Engineering,  Bilkent University. Since Fall 2022.
    \end{list2}
\vspace*{-.4cm}    
  \subsection{\small \sc Undergraduate Students in the Introduction to Research course}
 \begin{list2}  
\item
    {\bf Ebrar Bozkurt:} Spring 2023.
\item
    {\bf Hacı Çakın:} Spring 2023.
 \end{list2}
...
\textit{now: Instructor at Ashoka University, Haryana 131029, India}
\end{list2}
...
\begin{list2}
  \item
  {\bf Gözde Yazıcı:} Computer Engineering, Fall 2022.
  Bilkent University. \\
...
\begin{list2}
\item
  {\bf Elif Turan:} Intern in Summer 2022 at Bilkent.   {\it now: B.Sc. student at İzmir University of Economics.}
\item
...
\item
  ...
  \begin{list3}
    \item RECOMB 2023 (İstanbul, Turkey), RECOMB 2022 (San Diego, CA, USA),
...
\item
  ...
  (ACM-BCB)
  \begin{list3}
    \item ACM-BCB 2022 (Chicago, IL, USA), ACM-BCB 2021 (Virtual), ACM-BCB 2020 (Virtual), ACM-BCB 2019 (Niagara Falls, NY, USA), ACM-BCB 2017 (Boston, MA, USA).
  \end{list3}
...
\item
  ...
  (HIBIT)
  \begin{list3}
  \item HIBIT 2022 (Silifke, Turkey), HIBIT 2021 (Ankara, Turkey), HIBIT 2020 (Tuzla, Turkey), HIBIT 2017 (Güzelyurt, Northern Cyprus), HIBIT 2013 (Ankara, Turkey)
  \end{list3}
...
\begin{list2}
  \item CS 476 Automata Theory and Formal Languages: Fall 2014, 2015, 2016, 2017, 2022; Spring 2014, 2015, 2016, 2017, 2019, 2020, 2021, 2022. 
  \item CS 481 Bioinformatics Algorithms: Fall 2012, 2013, 2016, 2017, 2019, 2020, 2021, 2022.
  ...
  \item CS 202 Fundamental Structures of Computer Science II: Spring 2013, 2023; Fall 2021.
...
{\small
Total of 67 invited talks, seminars, lectures, and keynotes.
}\\
