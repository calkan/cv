...
\item
  ...
  2016-{\it present}.
\item
  Track and Area co-chair, 27$^{th}$ Annual International Conference on Intelligent Systems for Molecular Biology and the 18$^{th}$ European Conference on 
  Computational Biology
  (ISMB-ECCB 2019), 
  High Throughput Sequencing Analysis and Algorithms (HiTSeq) track and Comparative and Functional Genomics Area, July 22-25, 2019, Basel, Switzerland.
\item
...
{\small
Total of 59 invited talks, seminars, lectures, and keynotes.
}\\
