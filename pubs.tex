...
Z Bingöl, M Alser, O Mutlu, O Ozturk, C Alkan. 
...
\item
  ...
  \item
  GateKeeper-GPU: GPGPU design and implementation for GateKeeper algorithm to accelerate pre-alignment in DNA short read mapping.\\
