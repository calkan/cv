...
\vspace{-.2cm}
{\bf Pre-processing of paleogenomes: Mitigating reference bias and postmortem damage in ancient genome data.}  D Koptekin,  E Yapar,  KB Vural,  E Sağlıcan,  NE Altınışık,  AS Malaspinas,  \calkan,  M Somel. {\it Genome Biology}, \textit{accepted}, 2024. \textit{Preprint: bioRxiv 2023.11.11.566695.}
...
{\bf AirLift: a fast and comprehensive technique for translating alignments between reference genomes.} JS Kim, C Firtina, D Senol Cali,  N Hajinazar, M Alser, \calkan{}$^\ddag$, O Mutlu$^\ddag$.  {\it IEEE Transactions on Computational Biology and Bioinformatics}, epub August 19, 2024. \textit{Preprint: arXiv:1912.08735.}\\
         \hspace*{1cm}
{\footnotesize presented at {\em the 21$^{st}$ Asia Pacific Bioinformatics Conference (APBC 2023)}, Changsha, Hunan, China, April 14-16, 2023.}
