\section{\sc Publications}
                                       ...
                                       \small{
                                         Joint first authors are marked with $\ast$ in case of equal contribution. Joint last authors are marked with $\ddag$.
                                       }


\vspace{-.2cm}
    {\bf Rapid adaptive increase of amylase gene copy number in indigenous Andeans}. K Scheer, LJB Landau, K Jorgensen, C Karageorgiou, L Siao, \calkan{}, AM Morales-Rivera, C Osbourne, O Garcia, L Pearson, M Kiyamu, M Rivera-Chira, F Leon-Velarde, F Lee, T Brutsaert, AW Bigham, O Gokcumen. {\it Nature Communications}, to appear. Preprint: bioRxiv 2025.03.25.644684.
...
\vspace{-.2cm}
    {\bf BLEND: a fast, memory-efficient and accurate mechanism to find fuzzy seed matches in genome analysis.}
...
\vspace{-.2cm}
    {\bf A robust benchmark for detection of germline large deletions and insertions.}
...
\vspace{-.2cm}
    ...
    F Karaoğlanoğlu$^\ast$, C Ricketts$^\ast$, E Ebren, M Eslami Rasekh,  I Hajirasouliha$^\ddag$, \calkan{}$^\ddag$.
...
\vspace{-.2cm}
    {\bf Shouji: a fast and efficient computation of banded sequence alignment.} M Alser, H Hassan, A Kumar, O Mutlu$^\ddag$, \calkan{}$^\ddag$.
...
\vspace{-.2cm}
    ...
    A Soylev$^\ast$, T Le$^\ast$, H Amini, \calkan{}$^\ddag$, F Hormozdiari$^\ddag$.
...
\vspace{-.2cm}
    ...
    \hspace*{1 cm}{\footnotesize \em presented at the 25$^{th}$ Annual International Conference on Intelligent Systems for Molecular Biology and 16$^{th}$ European Conference on Computational Biology  (ISMB/ECCB 2017), July 21-25, 2017, Prague, Czech Republic.}
...
\vspace{-.2cm}        
    ...
    Ö. Acar$^\ast$, E Özkurt$^\ast$, G Demir, H Saraç, \calkan{}, T Esen, M Somel$^\ddag$, Nathan A Lack$^\ddag$.
...
\vspace{-.2cm}        
    ...
    F Hach$^\ast$, I Sarrafi$^\ast$, F Hormozdiari, \calkan{}, EE Eichler, SC Sahinalp. 
...
\vspace{-.2cm}
    {\bf Mapping copy number variation by population-scale genome sequencing.}
    RE Mills$^\ast$, K Walter$^\ast$, C Stewart$^\ast$, RE Handsaker$^\ast$, K Chen$^\ast$, 
    \calkan{}$^\ast$, A Abyzov$^\ast$, SC Yoon$^\ast$, K Ye$^\ast$ RK Cheetham, 
...
\vspace{-.2cm}
    {\bf Comparative and demographic analysis of orang-utan genomes}. 
...
\vspace{-.2cm}
    {\bf Limitations of next-generation genome sequence assembly}.
...
\vspace{-.2cm}
{\bf AirLift: a fast and comprehensive technique for remapping alignments between reference genomes.} JS Kim, C Firtina, D Senol Cali, M Alser, N Hajinazar, \calkan{}$^\ddag$, O Mutlu$^\ddag$. {\em The 21$^{st}$ Asia Pacific Bioinformatics Conference (APBC 2023)}, Changsha, Hunan, China, April 14-16, 2023.  \textit{Preprint: arXiv:1912.08735.}
...
\vspace{-.2cm}
{\bf GenASM: a high-performance, low-power approximate string matching acceleration framework for genome sequence analysis.}
...
%\vspace{-.2cm}
%{\bf Detection and characterization of novel sequence insertions using paired-end next-generation sequencing},
% I Hajirasouliha*, F Hormozdiari*, \calkan{}*, JM Kidd, I Birol, EE Eichler,
% SC Sahinalp.
...
%  \calkan{}, JA Bailey, EE Eichler, SC \c{S}ahinalp, E T\"{u}z\"{u}n.
...
\vspace{-.2cm}{\bf Copy number estimation using Counting Bloom Filters in \textit{de novo} assembled genomes.} K Zambaku, R Roman-Brenes, ÖY Öztürk, \calkan{}, I Birol. 27$^{th}$ Annual International Conference on Research in Computational Molecular Biology (RECOMB 2023), April 16-19, 2023, İstanbul, Türkiye. {\it Poster presentation by K Zambaku.}


\vspace{-.2cm}{\bf Identification of protein-protein interaction
hubs in multiple sclerosis.} G Yazıcı, B Kurt Vatandaslar, E Karakoç, B Kerman, \calkan{}.
...
\vspace{-.2cm}{\bf Whole genome alignment via Alternating Lyndon Tree Factorization.} MS Aydın and \calkan{}. 27$^{th}$ Annual International Conference on Research in Computational Molecular Biology (RECOMB 2023), April 16-19, 2023, İstanbul, Türkiye. {\it Poster presentation by MS Aydın.}
...
\vspace{-.2cm}{\bf Copy number estimation using Counting Bloom Filters in \textit{de novo} assembled genomes.} K Zambaku, R Roman-Brenes, ÖY Öztürk, \calkan{}, I Birol. 13$^{th}$ RECOMB Satellite Conference on Biological Sequence Analysis (RECOMB-Seq 2023), April 14-15, 2023, İstanbul, Türkiye. {\it Poster presentation by K Zambaku.}
...
\vspace{-.2cm}
{\bf GateKeeper-GPU: fast and accurate pre-alignment filtering in short read mapping.} Z Bingol, M Alser, O Ozturk, \calkan{}. 20$^{th}$ IEEE International Workshop on High Performance Computational Biology (HiCOMB), May 17, 2021, Portland, OR, United States.
...
\vspace{-.2cm}
       {\bf Discovery of large genomic inversions using long-range information.} F Karaoğlanoğlu, M Eslami Rasekh, \calkan{}.
...
\small{
Preprints later published in a journal or a peer-reviewed conference are moved from this section to their respective sections.
}

\vspace{-.2cm}
    {\bf LCPan: efficient variation graph construction using Locally Consistent Parsing.} A Ashyralyyev, Z Bingöl, BF Öz, S Malikic, U Vishkin, SC Sahinalp, \calkan{}. {\it arXiv:2511.12205}, posted Nov 15, 2025.
    \href{https://doi.org/10.48550/arXiv.2511.12205}{doi: 10.48550/arXiv.2511.12205}.

    
\vspace{-.2cm}
    {\bf Robust software development practices improve citations of RNA-seq tools}. S Sharma, E İlgün, T Okçu, V Ostash, V Bashynska, \calkan{}, E Myoung, NN Alpana, K Chhugani, D Deshpande, AAT Bui, K Ellrott, O Burduniuc, TV Tatarinova, V Munteanu, PP Łabaj, D Ciorba, V Bostan, M Dimian, M Pellegrini, M Alser, S Mangul. {\it bioRxiv}, posted September 10, 2025. \href{https://doi.org/10.1101/2025.09.05.674580}{doi: 10.1101/2025.09.05.674580}.

\vspace{-.2cm}
    {\bf Processing-in-memory for genomics workloads}. WA Simon, L Yavits, K Koliogeorgi, Y Falevoz, Y Shibuya, D Lavenier, I Boybat, K Zambaku, B Şahin, M Sadrosadati, O Mutlu, A Sebastian, R Chikhi, The BioPIM Consortium, \calkan{}. {\it arXiv:2506.00597}, posted May 31, 2025. \href{https://doi.org/10.48550/arXiv.2506.00597}{doi: 10.48550/arXiv.2506.00597}.
    

\vspace{-.2cm}
    {\bf Pairwise sequence alignment with block and character edit operations}. AC Alıcıoğlu, \calkan{}. {\it arXiv:2311.11082}, posted Nov 18, 2023. \href{https://doi.org/10.48550/arXiv.2311.11082}{doi: 10.48550/arXiv.2311.11082}

\vspace{-.2cm}
    {\bf GateSeeder: Near-memory CPU-FPGA acceleration of short and long read mapping}. J Eudine, M Alser, G Singh, \calkan{}, O Mutlu. {\it arXiv:2309.17063}, posted Sep 29, 2023. \href{https://doi.org/10.48550/arXiv.2309.17063}{doi: 10.48550/arXiv.2309.17063}.

\vspace{-.2cm}

    {\bf LEAP: a generalization of the Landau-Vishkin algorithm with custom gap penalties}. H Xin, J Kim, S Nahar, \calkan{}$^\ddag$, O Mutlu$^\ddag$. {\it bioRxiv}, posted May 7, 2017. \href{https://doi.org/10.1101/133157}{doi: 10.1101/133157}.

\vspace{-.2cm}
    {\bf Coinami: a cryptocurrency with DNA sequence alignment as proof-of-work}. AM Ileri, HI Ozercan, A Gundogdu, AK Senol, MY Ozkaya, \calkan{}. {\it arXiv:1602.03031}, posted Feb 9, 2016. \href{https://doi.org/10.48550/arXiv.1602.03031}{doi: 10.48550/arXiv.1602.03031}.
